...
- **Netzwerk-Visualisierung Startseite** (Stand Session 14b, 2026-04-29 abends): Desktop-Geometrie ist jetzt R_ROUTES=310, R_STATIONS=130, viewBox 1100×780 unveraendert. Stations-Daten sind ECHTE Storyblok-Namen, nicht mehr Platzhalter (siehe Session 14b oben fuer Details). 18 Stations + 19 gestrichelte Verlinkungen. Stations-Labels nach aussen versetzt mit Default-Offset 30, individuelle `labelOffsetExtra`-Overrides moeglich. **Offen**: Maggy bespricht mit Marilena ob das Layout so passt oder ob einzelne Stations raus / Labels vergroessert werden sollen via labelOffsetExtra. Mobile-Geometrie (Portrait-Ellipse) wurde diesmal NICHT angepasst — falls Mobile-Stand im Test zu eng wirkt, muss RX/RY_STATIONS dort auch nachgezogen werden (aktuell 125/260, kommt von Vor-Stufe-1).
