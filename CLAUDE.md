...
**Blog reaktiviert (Session 37, 2026-05-08, lokal):** 4 neue Artikel im FINAL-Stil unter `/blog/` (Definition / Medien-und-Demokratie-Pflichtfach / i.grow-Workflow / Frauenspuren), gefakte Daten 15.3.–3.5.2026 fuer "gewachsenen" Look. Eigener Blog-Index (`blog/index.html`, war Redirect) + Reaktivierung in `vitrine.html`. 4 interaktive Grafiken in `blog/figures/` als iframes mit JS-Auto-Resize. Sitemap + llms.txt erweitert. Tag-System ueberarbeitet (keine Grossbuchstaben, Header-Tags klickbar zu Sub-Marken-Seiten, Tag-Wolken farbig + erweitert bis 22 Tags bei Frauenspuren). Hero-Bild-Workflow per PIL aus den Site-Mockup-Posters etabliert. **Noch lokal — wartet auf Hero-Bilder Artikel 02–04 vor Push.** Status + Lehren in `_doku/sessions/2026-05-08-session-37-blog-reaktivierung.md`.
