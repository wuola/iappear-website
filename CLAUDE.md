...
- **Netzwerk-Visualisierung Startseite** (Stand 2026-04-16): Layout "konzentrische Ringe" — Rundgaenge aussen (R=290), Stationen innen (R=165), ViewBox 1100x780. Schriften seit Session 9 groesser: Tour-Labels 20px, Station-Labels 13px, Tour-Dots r=8. Stations-Daten sind weiterhin **Platzhalter** — echte Tour-Stations-Zuordnung muss noch nachgepflegt werden, dann loest sich auch die Label-Ueberlappung in der Mitte.
