...
- **Hero-Bilder Blog-Artikel 02–04** — Artikel 01 hat eines (PIL-komponiert aus Site-Mockup-Posters). Fuer 02–04 wartet Render auf Maggys Quell-Material. Pattern + PIL-Skript in Session 37.
- **Alter Slug `blog/medienbildung-vorarlberg-schueler-gestalten-stadtrundgaenge.html`** — verwaist nach Blog-Reaktivierung (nicht verlinkt, noindex, aus sitemap+llms raus). Wartet auf Maggy-Loeschung haendisch (`Remove-Item` ist auf Deny-Liste).
